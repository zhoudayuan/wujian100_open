...
$(IntermediateDirectory)/wujian100_open_wj_can$(ObjectSuffix): D:/test/prj-wujian-can/wujian100_open/sdk/csi_driver/wujian100_open/wj_can.c  
	@echo compiling wj_can.c...
	@$(CC) $(SourceSwitch) "D:/test/prj-wujian-can/wujian100_open/sdk/csi_driver/wujian100_open/wj_can.c" $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/wujian100_open_wj_can$(ObjectSuffix) -MF$(IntermediateDirectory)/wujian100_open_wj_can$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/wujian100_open_wj_can$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/wujian100_open_wj_can$(PreprocessSuffix): D:/test/prj-wujian-can/wujian100_open/sdk/csi_driver/wujian100_open/wj_can.c
	@echo generating preprocess file of wj_can.c...
	@$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/wujian100_open_wj_can$(PreprocessSuffix) "D:/test/prj-wujian-can/wujian100_open/sdk/csi_driver/wujian100_open/wj_can.c"
