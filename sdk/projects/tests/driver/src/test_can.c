...
int test_can(void)
{
    ...
    dtest_case_info_t test_case_info_array[] = {
        ...
        {"test_can_transmission",  test_can_transmission, CAN_TEST_CAN_TRANSMISSION_EN},
        //--------------//
...
static void test_can_transmission(void)
{
    uint8_t can_send_buf[] = {1, 2, 3, 4};
    wj_can_transmission(can_send_buf,  ARRAY_SIZE(can_send_buf));
}
